...
public:
    ...
    std::string csvStats(const std::string &impl, const std::string &profile, const std::string &trace_path, std::size_t N,
    double elapsed_ms, const std::string &probe_type, const std::string &compaction_state ) const;
